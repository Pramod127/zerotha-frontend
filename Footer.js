...
function  Footer () {
    ...
    <div className="container border-top mt-5" >
        <div className="row mt-5">
            <div className="col">
                <img src="media/logo.svg" style ={{width:"30%"}}alt="logo"></img>
                <p> 
    ...
    <a href =""style={{textDecoration:"none",lineHeight:"2.5"}}> About</a>
         ...
         <br/>
          ...
          <br/>
           ...
           <br/>
            <a href=" " style={{textDecoration:"none",lineHeight:"2.5"}}> Careers </a>
            <br/>
             <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>  Zerodha.tech</a>
             <br/>
              <a href=" "style={{textDecoration:"none",lineHeight:"2.5"}} > press &media</a>
              <br/>
               <a href=" "style={{textDecoration:"none",lineHeight:"2.5"}} > Zerodha cares(CSR) </a>
         ...
         <br/>
          <a href=""style={{textDecoration:"none",lineHeight:"2.5"}} >  z-connection blog  </a>
          <br/>
...
<a href="" style={{textDecoration:"none",lineHeight:"2.5"}}> videos </a>
         ...
         <a href=" "style={{textDecoration:"none",lineHeight:"2.5"}} >  Downloads & resources  </a>
         
         <br/>
          <a href=""style={{textDecoration:"none",lineHeight:"2.5"}} >  market overview   </a>
          <br/>
           <a href=" "style={{textDecoration:"none",lineHeight:"2.5"}}> How to fill a complaint?</a>
            <br/>
<a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>  Status of your complaint </a>
         ...
         <br/>
          <a href=""style={{textDecoration:"none",lineHeight:"2.5"}} >  found transfer </a>
        ...
        <br/>
        < div className="mt-5  fs-12 text-small text-muted">
